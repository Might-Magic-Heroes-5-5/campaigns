...
-- Ensures doFile('./scripts/h55_enums_creatures.lua') works in both H5M and H5U layouts.
...
if __h55__local_56424_PCALL(function() doFile('./h55_enums_creatures.lua') end) then
  __h55__local_56424_OK = 1
elseif __h55__local_56424_PCALL(function() doFile('h55_enums_creatures.lua') end) then
  __h55__local_56424_OK = 1
end
if not __h55__local_56424_OK then
  if write then write('[H55 ENUMS] ERR: cannot load h55_enums_creatures.lua via scripts/ loader.\n') end
  if ShowFlyingSign and GetCurrentPlayer and GetPlayerMainHero then
    __h55__local_56424_msg = 'H55 ENUMS: load error h55_enums_creatures.lua'
