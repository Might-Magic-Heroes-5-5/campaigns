...
function ressurect(loser, winner) --триггерна€ функци€, запускаетс€ после смерти геро€ PLAYER_2, респавнит  ол€на...или не респавнит
	if loser=='Nikolay' then --убитого геро€ зовут  ол€н?
		if winner~=nil then --его убили или сам слажал?
			if GetHeroCreatures(winner, CREATURE_PHOENIX) > 0 or OBJECTIVES.state.killDragons[2] == 10 then --были ли у убийцы фениксы в армии на конец битвы, или  ол€на убили при солнечном свете?
		...
		sleep(10) --без этой паузы следующа€ функци€ не стаботает!!!!
