...
OBJECTIVES = {
	...
	prepare = function()
		...
		CINEMATICS.intro();
		d = GetDifficulty();
		GiveExp(    "Sarge", 100000 + 40000 * d );
		GiveExp(     "Gles", 100000 + 40000 * d );
		GiveExp("Nathaniel", 100000 + 40000 * d );
		GiveExp(  "Straker", 100000 + 40000 * d );
		GiveExp("Christian", 100000 + 40000 * d);
		GiveExp(   "Tamika", 100000 + 40000 * d );
		GiveExp(    "Effig", 100000 + 40000 * d );
		AddHeroCreatures("Isabell",    CREATURE_MILITIAMAN, 500 + d * 500);
		AddHeroCreatures("Isabell",      CREATURE_MARKSMAN, 250  + d * 500 );
		AddHeroCreatures("Isabell",     CREATURE_SWORDSMAN, 150  + d *  200);
		AddHeroCreatures("Isabell", CREATURE_ROYAL_GRIFFIN, 100  + d *  200);
		AddHeroCreatures("Isabell",        CREATURE_CLERIC, 75  + d *  150);
		AddHeroCreatures("Isabell",       CREATURE_PALADIN, 50  + d *  70);
		AddHeroCreatures("Isabell",     CREATURE_ARCHANGEL, 25   + d *  60);
		AddObjectCreatures("necro_south_west", CREATURE_SKELETON_ARCHER, 100 + d * 100);
		AddObjectCreatures("necro_south_east", CREATURE_SKELETON_ARCHER, 100 + d * 100);
		AddObjectCreatures("haven_south_east",		  CREATURE_MARKSMAN, 500 + d * 500);
		AddObjectCreatures("haven_south_east",		 CREATURE_SWORDSMAN, 340 + d * 340);
		AddObjectCreatures("haven_south_east", 	 CREATURE_ROYAL_GRIFFIN, 180 + d * 180);
		AddObjectCreatures("haven_south_east",			CREATURE_CLERIC, 120 + d * 120);
		AddObjectCreatures("haven_south_west",		  CREATURE_MARKSMAN, 300 + d * 300);
		AddObjectCreatures("haven_south_west",		 CREATURE_SWORDSMAN, 200 + d * 200);
		AddObjectCreatures("haven_south_west",	 CREATURE_ROYAL_GRIFFIN, 120 + d * 120);
		AddObjectCreatures("haven_south_west",			CREATURE_CLERIC,  80 + d *  80);
		AddObjectCreatures("haven_north_east", CREATURE_SKELETON_ARCHER, 200 + d * 200);
		AddObjectCreatures("haven_north_east", 	 CREATURE_ROYAL_GRIFFIN,  50 + d *  50);
		AddObjectCreatures("haven_central", 		  CREATURE_MARKSMAN, 200 + d * 200);
		AddObjectCreatures("haven_central", 		 CREATURE_SWORDSMAN, 140 + d * 140);
		AddObjectCreatures("haven_central", 	 CREATURE_ROYAL_GRIFFIN,  60 + d *  60);
		AddObjectCreatures("haven_central", 			CREATURE_CLERIC,  40 + d *  40);
		AddObjectCreatures("haven_north_west1",			CREATURE_ARCHER, 200 + d * 200);
		AddObjectCreatures("haven_north_west1",	 CREATURE_ROYAL_GRIFFIN, 100 + d * 100);
		AddObjectCreatures("haven_north_west2",			CREATURE_ARCHER, 200 + d * 200);
		AddObjectCreatures("haven_north_west2",	 CREATURE_ROYAL_GRIFFIN,  60 + d *  60);
		AddObjectCreatures("haven_north_west2",	 		CREATURE_CLERIC,  50 + d *  50);
		AddObjectCreatures("haven_north_west2",		   CREATURE_PALADIN,  20 + d *  20);
