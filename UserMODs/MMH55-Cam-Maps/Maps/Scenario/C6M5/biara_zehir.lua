...
function Start()
	...
	sleep(10);
	SummonCreature(DEFENDER, 20, 60 + d * 5, 7, 12);
	sleep(10);
	SummonCreature(DEFENDER, 20, 60 + d * 5, 7, 3);
	sleep(10);
	SummonCreature(DEFENDER, 20, 60 + d * 5, 7, 8);
	sleep(10);
...
function DefenderCreatureDeath()
	...
	if death == 1 then
		sleep(10);
		SummonCreature(DEFENDER, 24, 35 + d * 5, 12, 8);
	end
	if death == 2 then
		sleep(10);
		SummonCreature(DEFENDER, 42, 20 + d * 5, 7, 12);
		sleep(10);
		SummonCreature(DEFENDER, 42, 20 + d * 5, 7, 3);
		sleep(1);
	end
...
function FindAttackerCreature()
            ...
            for index,creature in creatures do
                        if GetCreatureType(creature) == CREATURE_TITAN then
                                   return creature
                        end
            end
            return nil
