...
function Prepare()
	...
	sleep(10);
	SummonCreature(DEFENDER, 38, 35 + d * 5, 10, 8);
	sleep(10);
	SummonCreature(DEFENDER, 38, 35 + d * 5, 10, 3);
	sleep(10);
end
...
function Start()
	...
	sleep(10);
	SummonCreature(DEFENDER, 20, 45 + d * 5, 4, 5);
	sleep(10);
	SummonCreature(DEFENDER, 20, 40 + d * 5, 4, 8);
	sleep(10);
...
function DefenderCreatureDeath()
	...
	if death == 1 then
		sleep(10);
		SummonCreature(DEFENDER, 28, 25 + d * 5, 8, 6);
	end
	if death == 2 then
		sleep(10);
		SummonCreature(DEFENDER, 25, 7 + d * 5, 9, 6);
	end
	if death == 2 then
	sleep(10);
	SummonCreature(DEFENDER, 22, 35 + d * 5, 10, 6);
	end
