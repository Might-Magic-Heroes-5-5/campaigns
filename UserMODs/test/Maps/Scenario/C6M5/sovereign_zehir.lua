...
-- monsters: summon 2 ghosts, infernal succubus and balors
...
function Start()
    ...
    sleep(20);
    SummonCreature(DEFENDER, 41, 6 + d * 5, 12, 3);
    sleep(10);
    SummonCreature(DEFENDER, 41, 6 + d * 5, 12, 12);
    sleep(10);
    SummonCreature(DEFENDER, 41, 6 + d * 5, 12, 8);
    sleep(10);

    SummonCreature(DEFENDER, 23, 55 + d * 5, 13, 5);
    sleep(2);
    SummonCreature(DEFENDER, 22, 55 + d * 5, 13, 10);
    sleep(5);
